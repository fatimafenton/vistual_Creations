 ...
 "use strict";
	...
	function initNav(){		
	  if(easyMod){
		  ...
		  $(".bb-bookblock").each(function(){
			  $(this).append('<a class="menu-button open-menu">"Show Menu"<div></div><div></div><div></div></a><a class="bb-flip bb-nav-next">Next<img src="'+template_url+'/img/necessity/nav-next.png"/></a>')
		  });	
	            ...
	            function autoOpenPage(hash){           
		            ...
		            $("#nav-scroll li").each(function (i) {
		               /* var menu_item_str=$(this).html()
		                ...
		                var menu_item_hash_name = $(this).children('a').attr('href').split('#');
